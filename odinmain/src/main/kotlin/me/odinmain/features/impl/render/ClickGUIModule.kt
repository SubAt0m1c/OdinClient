...
object ClickGUIModule: Module(
    ...
    private val devSizeX: Float by NumberSetting("Dev Size X", 1f, -1f, 3f, 0.001, description = "X scale of the dev size.").withDependency { DevPlayers.isDev && devSize }
    private val devSizeY: Float by NumberSetting("Dev Size Y", 1f, -1f, 3f, 0.001, description = "Y scale of the dev size.").withDependency { DevPlayers.isDev && devSize }
    private val devSizeZ: Float by NumberSetting("Dev Size Z", 1f, -1f, 3f, 0.001, description = "Z scale of the dev size.").withDependency { DevPlayers.isDev && devSize }
